...
\begin{document}
\SingleHeader{PitmanController2\_TIME\_MC}
\MACHINE{PitmanController2\_TIME\_MC}{PitmanController}{c1,ctimers}{\\uses a better model of time, suited for model checking\\~  and deals better with tip-blinking timeout }
\VARIABLES{
	...
	\Variable{keyState}{}
	\Variable{curDeadlines}{}
}
\INVARIANTS{
	\Invariant{pred1}{false}{$curDeadlines \in{} TIMERS \pfun{} \nat{}$}{}
}
\EVENTS{
\INITIALISATION{true}{}{
	\ACTIONS{false}{
		...
		\Action{iniTime}{$curDeadlines \bcmeq{} \{blink\_deadline\mapsto{}500\}$}{true}{}
	}
}
...
\EVT{ENV\_Pitman\_TipBlinkingLeft\_Blink}{true}{ordinary}{ENV\_Pitman\_TipBlinkingLeft\_Blink}{}{
	...
	\ACTIONS{true}{
		...
		\Action{tip}{$curDeadlines(tip\_deadline) \bcmeq{} 500$}{true}{}
	}
}
...
\EVT{TIME\_Tip\_blinking\_Timeout}{true}{ordinary}{TIME\_Tip\_blinking\_Timeout}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd15}{false}{$rem = continuousBlink$}{false}{}
		\Guard{grd21}{false}{$delta \in{} \nat{}$}{true}{}
		\Guard{grd22}{false}{$tip\_deadline \in{} dom(curDeadlines)$}{true}{}
		\Guard{grd23}{false}{$delta = curDeadlines(tip\_deadline)$}{true}{}
		\Guard{grd24}{false}{$delta = min(ran(curDeadlines))$}{true}{}
	}
	\ACTIONS{true}{
		\Action{act1}{$remaining\_blinks \bcmeq{} rem$}{false}{}
		\Action{actTm}{$curDeadlines \bcmeq{} (\lambda{}x\qdot{}x \in{} dom(curDeadlines) \setminus{} \{tip\_deadline\}|curDeadlines(x) - delta)$}{true}{}
	}
}
\EVT{TIME\_Tip\_blinking\_Discard}{false}{ordinary}{}{}{
	\ANY{
		\Param{delta}{true}{}
	}
	\GUARDS{true}{
		...
		\Guard{grd23}{false}{$delta = curDeadlines(tip\_deadline)$}{true}{}
		\Guard{grd24}{false}{$delta = min(ran(curDeadlines))$}{true}{}
		\Guard{grd11}{false}{$\\\lnot{}(remaining\_blinks > 1\\~            \land{} pitmanArmUpDown \in{} PITMAN\_TIP\_BLINKING\\~            \land{} active\_blinkers=\{pitman\_direction(pitmanArmUpDown)\})$}{true}{\\negated guard of TIME$\_$Tip$\_$blinking$\_$Timeout}
	}
	\ACTIONS{true}{
		\Action{actTm}{$curDeadlines \bcmeq{} (\lambda{}x\qdot{}x \in{} dom(curDeadlines) \setminus{} \{tip\_deadline\}|curDeadlines(x) - delta)$}{true}{}
	}
...
\EVT{TIME\_BlinkerOn}{true}{ordinary}{TIME\_BlinkerOn}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd21}{false}{$delta \in{} \nat{}$}{true}{}
		\Guard{grd22}{false}{$blink\_deadline \in{} dom(curDeadlines)$}{true}{}
		\Guard{grd23}{false}{$delta = curDeadlines(blink\_deadline)$}{true}{}
		\Guard{grd24}{false}{$delta = min(ran(curDeadlines))$}{true}{}
	}
	\ACTIONS{true}{
		...
		\Action{actTm}{$\\curDeadlines \bcmeq{} (\lambda{}x\qdot{}x \in{} dom(curDeadlines) \setminus{} \{blink\_deadline\}|curDeadlines(x) - delta)\\~            \bunion{} \{blink\_deadline \mapsto{} 500\}$}{true}{}
	}
}
...
\EVT{TIME\_Passes}{false}{ordinary}{}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grdTm}{false}{$curDeadlines \neq{} \emptyset{} \limp{} delta \leq{} min(ran(curDeadlines))$}{true}{}
	}
	\ACTIONS{true}{
		\Action{actTm}{$curDeadlines \bcmeq{} (\lambda{}x\qdot{}x \in{} dom(curDeadlines)|curDeadlines(x) - delta)$}{true}{}
	}
}
}
\END
